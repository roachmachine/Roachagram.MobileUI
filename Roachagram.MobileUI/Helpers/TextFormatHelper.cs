/* PSEUDOCODE / PLAN
 - Add XML documentation to the class and each public method.
 - Document purpose, parameters, return values, and notable behavior (regex semantics, null behavior).
 - Keep original method implementations unchanged.
 - Place the pseudocode comment at the top of the file so the file remains a single code block.
*/
